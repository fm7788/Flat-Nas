export const cityData: Record<string, string[]> = {
  "直辖市": ["北京", "上海", "天津", "重庆"],
  "广东": ["广州", "深圳", "珠海", "佛山", "东莞", "中山", "惠州", "江门", "汕头", "湛江", "韶关", "河源", "梅州", "汕尾", "阳江", "清远", "潮州", "揭阳", "云浮", "肇庆", "茂名"],
  "浙江": ["杭州", "宁波", "温州", "绍兴", "嘉兴", "金华", "台州", "湖州", "衢州", "丽水", "舟山"],
  "江苏": ["南京", "苏州", "无锡", "常州", "南通", "扬州", "徐州", "泰州", "镇江", "盐城", "淮安", "连云港", "宿迁"],
  "福建": ["福州", "厦门", "泉州", "漳州", "莆田", "龙岩", "三明", "南平", "宁德"],
  "湖南": ["长沙", "株洲", "湘潭", "衡阳", "邵阳", "岳阳", "常德", "张家界", "益阳", "郴州", "永州", "怀化", "娄底", "湘西"],
  "湖北": ["武汉", "黄石", "十堰", "宜昌", "襄阳", "鄂州", "荆门", "孝感", "荆州", "咸宁", "随州", "恩施"],
  "山东": ["济南", "青岛", "淄博", "枣庄", "东营", "烟台", "潍坊", "济宁", "泰安", "威海", "日照", "临沂", "德州", "聊城", "滨州", "菏泽"],
  "四川": ["成都", "自贡", "攀枝花", "泸州", "德阳", "绵阳", "广元", "遂宁", "内江", "乐山", "南充", "眉山", "宜宾", "广安", "达州", "雅安", "巴中", "资阳"],
  "河南": ["郑州", "开封", "洛阳", "平顶山", "安阳", "鹤壁", "新乡", "焦作", "濮阳", "许昌", "漯河", "三门峡", "南阳", "商丘", "信阳", "周口", "驻马店"],
  "河北": ["石家庄", "唐山", "秦皇岛", "邯郸", "邢台", "保定", "张家口", "承德", "沧州", "廊坊", "衡水"],
  "陕西": ["西安", "铜川", "宝鸡", "咸阳", "渭南", "延安", "汉中", "榆林", "安康", "商洛"],
  "安徽": ["合肥", "芜湖", "蚌埠", "淮南", "马鞍山", "淮北", "铜陵", "安庆", "黄山", "阜阳", "宿州", "亳州", "六安", "滁州", "宣城", "池州"],
